    ...
    uiModels.forEach { uiModel ->
        when (uiModel) {
            ...
            is LibraryUpdateErrorUiModel.Item -> {
                item(
                    key = "error-${uiModel.item.error.errorId}-${uiModel.item.error.animeId}",
                    contentType = "item",
                ) {
                    ...
                    LibraryUpdateErrorUiItem(
                        ...
                        animeCover = libraryUpdateErrorItem.animeCover,
...
private fun LibraryUpdateErrorUiItem(
    ...
    animeCover: tachiyomi.domain.anime.model.AnimeCover,
    sourceName: String,
    selected: Boolean,
    onClick: () -> Unit,
    onLongClick: () -> Unit,
