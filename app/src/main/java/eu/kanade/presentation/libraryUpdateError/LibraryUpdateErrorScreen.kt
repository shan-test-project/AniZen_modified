        ...
        topBar = { scrollBehavior ->
            LibraryUpdateErrorAppBar(
                title = stringResource(
                    SYMR.strings.label_library_update_errors,
                    state.items.size,
                ),
...
private fun LibraryUpdateErrorBottomBar(
    ...
    Surface(
        ...
        Row(
            ...
            BottomMenuButton(
                title = stringResource(SYMR.strings.action_scroll_to_previous),
            ...
            BottomMenuButton(
                title = stringResource(SYMR.strings.action_scroll_to_next),
