...
fun AspectRatioSheet(
    ...
    val presetRatios =
        listOf(
            AspectRatioItem("Default", -1.0),
            AspectRatioItem("4:3", 4.0 / 3.0),
            AspectRatioItem("16:9", 16.0 / 9.0),
            AspectRatioItem("16:10", 16.0 / 10.0),
            AspectRatioItem("21:9", 21.0 / 9.0),
            AspectRatioItem("32:9", 32.0 / 9.0),
            AspectRatioItem("1:1", 1.0),
            AspectRatioItem("2.35:1", 2.35),
            AspectRatioItem("2.39:1", 2.39),
        )
    ...
    Column(
        ...
        errorMessage?.let { msg ->
            Text(
                ...
                modifier = Modifier.padding(start = MaterialTheme.padding.small, top = 4.dp),
            )
        }
    }
}
